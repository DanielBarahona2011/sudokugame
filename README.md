# 🧩 Juego de Sudoku - Aplicación de Escritorio Completa

[![Python](https://img.shields.io/badge/Python-3.14-blue.svg)](https://python.org)
[![Interfaz](https://img.shields.io/badge/Interfaz-Tkinter-green.svg)](https://docs.python.org/3/library/tkinter.html)
[![Base de Datos](https://img.shields.io/badge/BaseDatos-SQLite-orange.svg)](https://sqlite.org)
[![Release](https://img.shields.io/badge/Release-v1.0-brightgreen.svg)](https://github.com/DanielBarahona2011/sudokugame/releases)
...
**[📥 Descargar Sudoku_Game.exe (20.3 MB)](./release/Sudoku_Game.exe)**

- ✅ **Sin instalación** - Ejecutar directamente
- ✅ **Portátil** - Llevar en USB
...
5. **Completa** el puzzle siguiendo las reglas del Sudoku
...
- **Modelo** (`sudoku_game.py`) - Lógica de negocio y reglas
- **Vista** (`sudoku_gui.py`) - Interfaz de usuario y eventos  
- **Controlador** (`main.py`) - Coordinación y control de flujo
...
### Pantalla Principal
- Tablero 9x9 con diseño moderno y limpio
- Panel lateral con números 1-9 para fácil acceso
- Cronómetro y puntuación en tiempo real

### Selección de Dificultad
- Interfaz limpia para elegir nivel de juego
...
**Daniel Barahona**
- Proyecto desarrollado como aplicación de escritorio completa
- Implementa todas las funcionalidades de un juego profesional
- Base de datos integrada con sistema de ranking competitivo
